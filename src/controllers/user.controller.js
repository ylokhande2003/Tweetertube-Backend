...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    const oldavaterUrl = req.user?.avatar;
    if (oldavaterUrl) {
        await deleteOnCloudinary(oldavaterUrl);
    }
...
const addUserToWatchHistory = asyncHandler (async(req, res) => {
